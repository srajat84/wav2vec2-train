...
validation_dataset='openslr_google'
...
subset='valid'
w2l_decoder='kenlm'
lm=1 # 0 for viterbi and 1 for kenlm
beam=128
...
if [ "${lm}" = 0 ]; then
	...
	--lm-weight 2 --word-score -1 --sil-weight 0 --criterion ctc --labels ltr --max-tokens 4000000 --lexicon ${parentdir}/data/finetuning/lexicon.lst \
