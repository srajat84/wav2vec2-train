...
data_path="/home/anirudh/2020_kn_1/openslr_kannada/validation_datasets/open_slr_kannada/wav_16"
prep_scripts="/home/anirudh/common_scripts/prep_scripts"
valid_folder="openslr_google"
...
python ${prep_scripts}/labels.py --jobs 64 --tsv ${valid_path}/valid.tsv --output-dir ${valid_path} --output-name valid --txt-dir ${data_path}/../google
